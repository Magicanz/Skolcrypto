...
const uint64_t MONEY_SUPPLY                                  = (uint64_t)(1333333337);
const unsigned EMISSION_SPEED_FACTOR                         = 20;
static_assert(EMISSION_SPEED_FACTOR <= 8 * sizeof(uint64_t), "Bad EMISSION_SPEED_FACTOR");

//TODO Define number of blocks for block size median calculationcconst size_t   CRYPTONOTE_REWARD_BLOCKS_WINDOW               = 100;
...
const char     CRYPTONOTE_NAME[]                             = "Skolcrypto";
